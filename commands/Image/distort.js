...
module.exports = {
  name: "distort",
  category: "Image",
  usage: "distort [user mention, user id]",
  aliases: [""],
  ...
  run: async (client, message, args) => {
    ...
    const m = await message.reply({ content: `<a:is_loading:923892698782511125> **Distorting user's avatar.. Hold On...**`,  components: [row] })
    await wait(3000);
    ...
    m.edit({
    content: "**<:rabbitslash:913423874182500352> Try this with slash command \`/image distort\`**",
