...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const m = await message.reply({ content: `<a:is_loading:923892698782511125> **Fast forwarding the years... Hold On...**`,  components: [row] })
    ...
    m.edit({
    content: "**<:rabbitslash:913423874182500352> Try this with slash command \`/image 3000years\`**",
