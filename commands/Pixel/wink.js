...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const m = await message.reply({ content: `<a:is_loading:923892698782511125> **Fetching a wink image...**`,  components: [row] })
    await wait(2000);
    m.edit({
    content: "**<:rabbitslash:913423874182500352> Try slash command \`/pixel wink\`**",
