...
module.exports = {
 name: "end-giveaway",
 aliases: ["gend"],
 description: "Ends any current running giveaways",
 category: "Utility",
 usage: "end-giveaway <giveaway id>",
 run: async (client, message, args) => {
  ...
  if (message.member.hasPermission("MANAGE_MESSAGES")) {
   ...
   client.giveawaysManager
    ...
    .setColor("#fc217b")
    .setTitle("<:checkvector:869193650184269834> GIVEAWAY END SUCCESS!")
    .setDescription("Successfully ended the giveaway")
