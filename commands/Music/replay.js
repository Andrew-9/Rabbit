...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const replaying = new Discord.MessageEmbed()
    .setColor(config.colors.playmode)
    .setThumbnail(cursong.thumbnail)
    .setTitle("<:musicblues:888396777202520124> RE PLAYING CURRENT SONG!")
    .setDescription(`Replaying the current track \`${cursong.name}\``)
