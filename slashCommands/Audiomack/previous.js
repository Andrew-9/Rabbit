...
module.exports = {
	name: "previous",
	description: "Play the previou song!",
	cooldown: 10,
	...
	run: async (client, interaction) => {
		try {
			...
			content: `**${emoji} Easily use this same command with \`${prefix}previous\`**`,
			...
			.setDescription(`Now playing audiomack's previous played track!`)
			]
			});
			} catch (e) {
