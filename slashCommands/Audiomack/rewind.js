...
module.exports = {
	name: "rewind",
	description: "Rewinds the song by seconds",
	cooldown: 10,
	...
	options: [
		{
			"Integer": {
				name: "amount",
				description: "How many seconds shall i rewind?",
				required: true
			}
		},
	],
	run: async (client, interaction) => {
		try {
			...
			content: `**${emoji} Easily use this same command with \`${prefix}rewind\`**`,
			...
			let seekNumber = options.getInteger("amount")
